const ramos = [
  ...
  { nombre: "Taller de Programación (Matlab/Simulink)", codigo: "INIE25", semestre: 2, prerrequisitos: ["INIE13"] },
  ...
  { nombre: "Emprendimiento I", codigo: "INEM31", semestre: 3, prerrequisitos: [] },
  ...
  { nombre: "Práctica Profesional I", codigo: "IEIEP1", semestre: 4, prerrequisitos: [] },
  ...
  { nombre: "Inglés II", codigo: "INGL6", semestre: 5, prerrequisitos: ["INGL5"] },
  { nombre: "Hito de Evaluación I", codigo: "IEIEH1", semestre: 5, prerrequisitos: [] },
  ...
  { nombre: "Operación y Mantenimiento Industrial", codigo: "IEIE74", semestre: 7, prerrequisitos: ["IEIE54"] },
  { nombre: "Conversión Electromecánica de la Energía", codigo: "IEIE76", semestre: 7, prerrequisitos: ["IEIE54"] },
  { nombre: "Emprendimiento II", codigo: "INEM71", semestre: 7, prerrequisitos: [] },
  ...
  { nombre: "Mención Electiva I", codigo: "IEIE85", semestre: 8, prerrequisitos: [] },
  { nombre: "Práctica Profesional II", codigo: "IEIEP2", semestre: 8, prerrequisitos: ["IEIEP1"] },
  ...
  { nombre: "Mención Electiva V", codigo: "IEIEX4", semestre: 9, prerrequisitos: [] },

  { nombre: "Hito de Evaluación III", codigo: "IEIE96", semestre: 10, prerrequisitos: [] }
];
